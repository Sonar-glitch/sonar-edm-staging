...
# Fix for NextAuth syntax error

# Set the project root directory
cd /c/sonar/users/sonar-edm-user

# Create backup of NextAuth file
echo "Backing up NextAuth configuration..."
cp "./pages/api/auth/[...nextauth].js" "./pages/api/auth/[...nextauth].js.backup"

# Manually fix the NextAuth configuration
...
git commit -m "Fix NextAuth syntax error"

# Deploy to Heroku
echo "Deploying to Heroku..."
git push heroku main

echo "NextAuth configuration fix complete!"
