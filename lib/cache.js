import cityRequestQueueModule from './cityRequestQueue'; // Import the whole module as default
const connectToDatabase = cityRequestQueueModule.connectToDatabase; // Access the function from the imported module
