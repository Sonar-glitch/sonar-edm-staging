...
class MusicApiService {
  ...
  let enhancedScore = Number.isFinite(event.personalizedScore) ? event.personalizedScore : 0;
      let scoreBoosts = [];
      ...
      return {
        enhancedScore,
  originalScore: Number.isFinite(event.personalizedScore) ? event.personalizedScore : 0,
        confidence,
      ...
      return {
  enhancedScore: Number.isFinite(event.personalizedScore) ? event.personalizedScore : 0,
  originalScore: Number.isFinite(event.personalizedScore) ? event.personalizedScore : 0,
        confidence: 'low',
        artistsAnalyzed: 0,
        scoreBoosts: [],
