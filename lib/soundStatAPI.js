...
class SoundStatAPI {
  ...
  // SoundStat API configuration (from environment)
  this.apiKey = process.env.SOUNDSTAT_API_KEY || '[REDACTED_SOUNDSTAT_API_KEY]';
  this.baseUrl = process.env.SOUNDSTAT_BASE_URL || 'https://soundstat.info/api/v1';
  this.apiEnabled = !!(this.apiKey && this.apiKey !== '[REDACTED_SOUNDSTAT_API_KEY]');
