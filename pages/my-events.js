                ...
                >
                  ...
                  <div className={styles.eventFooter}>
                    ...
                    <span className={`${styles.sourceTag} ${
                      event.source === 'ticketmaster' || event.source === 'Ticketmaster' || event.source === 'mongodb' || event.source === 'manual' ? styles.liveTag : 
                      event.source === 'emergency' ? styles.emergencyTag : styles.sampleTag
                    }`}>
                      {/* FIX 3: Show "Live Data" for both ticketmaster and mongodb events */}
                      {event.source === 'ticketmaster' || event.source === 'Ticketmaster' || event.source === 'mongodb' || event.source === 'manual' ? 'Live Data' : 
