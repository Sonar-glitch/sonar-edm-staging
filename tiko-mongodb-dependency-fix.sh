#!/bin/bash
# TIKO MongoDB Dependency Fix Script
# This script adds the missing mongodb dependency along with chart.js, react-chartjs-2, and axios
...
echo -e "${BLUE}=== TIKO MongoDB Dependency Fix Script ===${NC}"
echo -e "${BLUE}This script adds the missing mongodb dependency along with chart.js, react-chartjs-2, and axios${NC}\n"

# Create backup directory
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
BACKUP_DIR="./backups/mongodb_fix_${TIMESTAMP}"
mkdir -p $BACKUP_DIR
...
# Update package.json to add mongodb, chart.js, react-chartjs-2, and axios dependencies
...
echo -e "${GREEN}Updated package.json with mongodb, chart.js, react-chartjs-2, and axios dependencies${NC}"
